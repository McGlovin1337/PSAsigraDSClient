...
## SYNOPSIS
Update an existing Weekly Schedule Detail

## SYNTAX

```
Set-DSClientWeeklySchedule [[-RepeatWeeks] <Int32>] [[-ScheduleDays] <String[]>] [-DetailId] <Int32>
 [-ScheduleId] <Int32> [-StartDate <DateTime>] [-EndDate <DateTime>] [-StartTime <String>] [-EndTime <String>]
...
## DESCRIPTION
Update an existing Weekly Schedule Detail belonging to a Schedule. Use Get-DSClientScheduleDetail to determine DetailId.
This Cmdlet can only update existing Schedule Details of Type Weekly

## EXAMPLES

### Example 1
```powershell
PS C:\> Set-DSClientWeeklySchedule -ScheduleId 10 -DetailId 5 -RepeatWeeks 2 -ScheduleDays 'Monday', 'Wednesday', 'Friday'
```

Update the Weekly Schedule Detail with DetailId 5 belonging to ScheduleId 10, to run every 2 Weeks on Monday, Wednesday and Friday
